...
class PasswordManagerApp(ctk.CTk):
    ...
    def _add_entry_row(self, row_idx: int, site: str, data: dict):
        ...
        ctk.CTkButton(frame, text="vedi", width=34, height=30, fg_color="transparent",
                    hover_color=("gray85", "gray25"),
                    command=toggle_show).grid(row=0, column=3, rowspan=2, padx=2)

        ctk.CTkButton(frame, text="copia", width=34, height=30, fg_color="transparent",
                    hover_color=("gray85", "gray25"),
                    command=lambda s=site: self._copy_password(s)).grid(row=0, column=4, rowspan=2, padx=2)

        ctk.CTkButton(frame, text="mod", width=34, height=30, fg_color="transparent",
                    hover_color=("gray85", "gray25"),
                    command=lambda s=site: self._open_edit_dialog(s)).grid(row=0, column=5, rowspan=2, padx=2)

        ctk.CTkButton(frame, text="del", width=34, height=30, fg_color="transparent",
                    hover_color=("gray85", "gray25"),
    ...
    def _open_add_dialog(self, prefill_site="", prefill_user="", prefill_pwd="", edit=False):
        ...
        ctk.CTkButton(pwd_frame, text="gen", width=38, height=38, command=gen).grid(row=0, column=1, padx=(4, 0))
